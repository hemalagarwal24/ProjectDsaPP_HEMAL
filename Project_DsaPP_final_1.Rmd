...
#2.Understanding the proportion of Exciting projets                                  
```{r}
...
prop_exciting<- data_excitingProjects.freq$Freq[(data_excitingProjects.freq$data_excitingProjects=="t")]/ length(data_outcomes$is_exciting)
prop_exciting
 #0.05927411
```
Analysis
...
#4.Projects with atleast one Green donation
```{r}
...
#5Are schools with higher poverty levels likely to get funded any more than schools with lower poverty levels. 
```{r}
...
#DATA STORY
#2.Are peoply like to make more donations in certain months??
